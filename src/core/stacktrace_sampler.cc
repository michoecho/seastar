/*
 * The stack sampler; see include/seastar/core/stacktrace_sampler.hh.
 *
 ...
 * tracepoint call site is here rather than in src/core/tracer.cc only because
 ...
 * see the header comment on <seastar/core/tracer.hh>.
 */
...
// Leaked for the same reason the rings in src/core/tracer.cc are: a reactor is
